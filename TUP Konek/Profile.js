...
function toggleLike(btn, base) {
  ...
  if (icon.tagName === 'IMG') {
    icon.src = liked ? 'images/heart_reacted.png' : 'images/heart_react.png';
  }
...
function toggleRepost(btn) {
  ...
  if (icon.tagName === 'IMG') {
    icon.src = reposted ? 'images/reposted.png' : 'images/repost.png';
  }
  ...
  card.innerHTML = `
    <div class="post-header">
      <div class="post-avatar">
        <img src="images/use_prof.jpg" alt="Samantha" onerror="this.parentElement.textContent='👩'">
      </div>
      <div class="post-meta">
    ...
    <div class="repost-label">
      <img src="images/reposted.png" class="repost-label-icon"> You Reposted
    </div>
    ...
    <div class="comment-input-row always-visible" onclick="openCommentModal(this)">
      <div class="comment-avatar">
        <img src="images/use_prof.jpg" alt="You" onerror="this.parentElement.textContent='👩'">
      </div>
...
function submitPost() {
  ...
  const avatar  = isAnon ? '' : 'images/use_prof.jpg';
...
function submitModalComment() {
  ...
  const list = document.getElementById('commentModalList');
  list.appendChild(buildCommentModalItem('Samantha Egar', 'images/use_prof.jpg', text, 'Just now'));
  ...
  if (_currentPostCard) {
    ...
    cd.dataset.avatar = 'images/use_prof.jpg';
